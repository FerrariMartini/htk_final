                                        ...
                                        <table class="table table-borderless table-responsive-lg">
                                            ...
                                            <tr>
                                                <td>
                                                    <div>
                                                        <div>
                                                            <label for="exercisesList"></label><select
                                                                class="custom-select"
                                                                id="exercisesList"
                                                                name="exList">
                                                            <option value="Andar de bicicleta">Andar de bicicleta
                                                            </option>
                                                            ...
                                                            <option value="Caminhada - 7km/h">Caminhada - 7km/h</option>
                                                            <option value="Caminhar - 4km/h">Caminhar - 4km/h</option>
                                                            <option value="Capoeira">Capoeira</option>
                                                            <option value="Corrida">Corrida</option>
                                                            <option value="Dança de Salão">Dança de Salão</option>
                                                            <option value="Ginástica aeróbica">Ginástica aeróbica
                                                            </option>
                                                ...
                                                <td>
                                                    <div>
                                                        <label class="sr-only" for="currentTime">tempo</label>
                                                ...
                                                <td>
                                                    <div>
                                                        <label class="sr-only" for="currentCalories">calorias</label>
                                                        <input type="text" class="form-control" name="caloriesExercises"
                                                               id="currentCalories"
                                                ...
                                                <table class="table table-borderless table-responsive-lg">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <div>
                                                                    <label for="alimentoListBfk"></label><select
                                                                        class="custom-select"
                                                                        id="alimentoListBfk" name="breakfast_list">
                                                        ...
                                                        <td>
                                                            <div>
                                                                <label class="sr-only" for="porcao">porções</label>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <label class="sr-only" for="qtd">quantidade</label>
                                                        ...
                                                        <td>
                                                            <div>
                                                                ...
                                                                <input type="text" class="form-control" name="caloriesBkf"
                                                                       id="calorias"
